...
const Navbar = () => {
  return (
    <nav className="sticky top-4 z-50 mx-auto flex max-w-[700px] items-center justify-between rounded-lg border-[1px] border-white bg-white px-6 py-4 font-medium text-gray-800 shadow-sm">
