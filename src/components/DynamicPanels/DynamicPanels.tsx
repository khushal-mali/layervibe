...
const DynamicPanels = () => {
  ...
  return (
    ...
    >
      <div className="relative mb-12 w-full max-w-[1250px] space-y-10 max-[1280px]:px-6 min-[800px]:mb-30">
        <div className="absolute right-0 bottom-0 z-0 h-[100px] w-[100px] translate-x-1/2 translate-y-3/4 rounded-full bg-[#DFFF19] max-[1280px]:translate-x-1/3"></div>
